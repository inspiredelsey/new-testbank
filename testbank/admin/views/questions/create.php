    ...
    <div class="col-xl-9 col-lg-10">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center gap-2">
                ...
                <h5 class="mb-0 fw-semibold">Create Question</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form action="index.php?route=admin/questions&action=create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="type" name="type" required onchange="toggleTypeEditor(this.value)">
                                <option value="mcq_single" selected>Multiple Choice (Single Answer)</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="points" name="points" value="1.0" step="0.25" min="0.25" required>
                        </div>

                        <!-- Question Text -->
                        <div class="col-12 mb-3">
                            <label for="question_text" class="form-label fw-medium">Question Prompt / Text <span class="text-danger">*</span></label>
                            <textarea class="form-control font-sans" id="question_text" name="question_text" rows="5" required placeholder="Type the core question here..."></textarea>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-text">Max size 2MB. Permitted: JPG, PNG, GIF.</div>
                        </div>

                        <!-- Tags -->
                        <div class="col-md-6 mb-4">
                            <label for="tags" class="form-label fw-medium">Tags (Optional)</label>
                            <input type="text" class="form-control" id="tags" name="tags" placeholder="biology, cells, genetics">
                    ...
                    <div id="mcq-editor-section" class="options-sub-editor mb-4">
                        ...
                        <div id="mcq-options-container">
                            <!-- JS will inject options or we have default rows -->
                            <div class="row align-items-center mb-3 option-row" data-index="0">
                                <div class="col-auto">
                                    <input type="radio" name="mcq_correct_single" value="0" class="form-check-input correct-marker-single" checked>
                                    <input type="checkbox" name="mcq_correct_multi[0]" class="form-check-input correct-marker-multi d-none">
                                </div>
                                <div class="col">
                                    <input type="text" name="options[0]" class="form-control" placeholder="Option Answer text..." required>
                                </div>
                                <div class="col-auto">
                                    <button type="button" class="btn btn-outline-danger btn-sm border-0" onclick="removeOptionRow(this)"><i data-lucide="x"></i></button>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3 option-row" data-index="1">
                                <div class="col-auto">
                                    <input type="radio" name="mcq_correct_single" value="1" class="form-check-input correct-marker-single">
                                    <input type="checkbox" name="mcq_correct_multi[1]" class="form-check-input correct-marker-multi d-none">
                                </div>
                                <div class="col">
                                    <input type="text" name="options[1]" class="form-control" placeholder="Option Answer text..." required>
                                </div>
                                <div class="col-auto">
                                    <button type="button" class="btn btn-outline-danger btn-sm border-0" onclick="removeOptionRow(this)"><i data-lucide="x"></i></button>
                                </div>
                    ...
                    <div id="tf-editor-section" class="options-sub-editor mb-4 d-none">
                        ...
                        <div class="form-check form-check-inline p-3 border rounded border-light-subtle px-4">
                            <input class="form-check-input" type="radio" name="tf_correct" id="tf_correct_true" value="true" checked>
                            <label class="form-check-label fw-medium" for="tf_correct_true">True</label>
                        </div>
                        <div class="form-check form-check-inline p-3 border rounded border-light-subtle px-4">
                            <input class="form-check-input" type="radio" name="tf_correct" id="tf_correct_false" value="false">
