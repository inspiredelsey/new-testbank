...
<div class="container" style="max-width: 480px;">
    ...
    <div class="text-center mb-4">
        ...
        <h2 class="display-font fw-bold text-dark mb-1">Test Bank LMS</h2>
        <p class="text-muted small">Question Bank & Exam Management System</p>
    </div>
    ...
    <div class="card login-card border border-light-subtle bg-light-subtle mt-4 text-center py-3 px-4">
        <h6 class="fw-bold mb-1 small text-dark d-flex align-items-center justify-content-center gap-1"><i data-lucide="key" size="14"></i> Default Admin Credentials:</h6>
        <p class="mb-0 small text-muted">Email: <code>admin@testbank.com</code> | Password: <code>admin123</code></p>
    </div>
