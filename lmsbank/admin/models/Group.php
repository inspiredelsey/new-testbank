<?php
/**
 * Group Model Class for LMS Bank
...
class Group {
    ...
    public static function delete($id) {
        ...
        // 3. Delete group (hard-delete is safe because constraints were checked and we have ON DELETE CASCADE/SET NULL where applicable)
        try {
